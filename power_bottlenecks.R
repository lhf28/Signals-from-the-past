...
title(ylab = "Power")
legend("right", cex = 0.9, c("Neutral Tajima's D", "Neutral nucleotide diversity (π)","Extreme bottleneck Tajima's D", "Extreme bottleneck nucleotide diversity (π)"), col = c("pink", "lightblue", "pink", "lightblue"), pch = 21, lty = c(2,2,1,1))
### s = 0.06
load("Tajneutralpwr2.RData")
...
title(xlab = "Time interval")
title(ylab = "Power")
legend("bottomright", cex = 0.9, c("Neutral Tajima's D", "Neutral nucleotide diversity (π)","Extreme bottleneck Tajima's D", "Extreme bottleneck nucleotide diversity (π)"), col = c("pink", "lightblue", "pink", "lightblue"), pch = 21, lty = c(2,2,1,1))
### s = 0.06
load("Tajneutralpwr2.RData")
coeff3taj <- c(FPRs3[[1]][1],FPRs3[[2]][1],FPRs3[[3]][1],FPRs3[[4]][1],FPRs3[[5]][1],FPRs3[[6]][1])
load("nuc_divneutralpwr2.RData")
coeff3nucdiv <- c(FPRs7[[1]][1],FPRs7[[2]][1],FPRs7[[3]][1],FPRs7[[4]][1],FPRs7[[5]][1],FPRs7[[6]][1])
load("TajMBotpwr2.RData")
coeff4taj <- c(FPRs4[[1]][1],FPRs4[[2]][1],FPRs4[[3]][1],FPRs4[[4]][1],FPRs4[[5]][1],FPRs4[[6]][1])
load("nuc_divMBotpwr2.RData")
